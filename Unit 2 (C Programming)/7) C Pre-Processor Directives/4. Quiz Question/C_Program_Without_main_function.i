# 0 ".\\C_Program_Without_main_function.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 ".\\C_Program_Without_main_function.c"
...
# 2 ".\\C_Program_Without_main_function.c" 2
...
# 3 ".\\C_Program_Without_main_function.c" 2





# 7 ".\\C_Program_Without_main_function.c"
int main()
{
    printf("Hello, world!\n");
    return 0;
